...
public class TTags {
  ...
  */
  ...
  protected String[] openTagsArray() {
    if (openTagsCache == null) {
      Set<String> open = getOpenTags();
      openTagsCache = deterministicallyExpandTags(open.toArray(new String[open.size()]));
    }
    return openTagsCache;
  }
}
